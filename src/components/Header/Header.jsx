...
export default function Header() {
  return (
    <header className="w-11/12 xl:w-8/12 mx-auto mt-5 flex flex-col ">
      <nav>
        <Navbar />
      </nav>
      <section className="hidden lg:w-11/12 mx-auto lg:mt-24 lg:flex justify-between gap-x-20 items-center">
